...
export default function PrivacyPolicy() {
  ...
  return (
    <div className="privacy-policy">
      ...
      <p>
        David Thomas Pizarro Frick te informa sobre su Política de Privacidad y
        Cookies respecto del tratamiento y protección de los datos de carácter
      ...
      <ul>
        <li>Titular: David Thomas Pizarro Frick</li>
        <li>Correo electrónico: davidpizarrofrick@gmail.com</li>
        <li>Sitio Web: www.dtpf.es</li>
      </ul>
      ...
      <p>
        Para navegar por dtpf.es no es necesario que facilites ningún dato
      ...
      <p>
        ...
        davidpizarrofrick@gmail.com junto con la prueba válida en derecho como una
      ...
      <p>
        ...
        ser tu dirección IP, nombre y apellidos, dirección de correo
        ...
        recopilada, utilizada, gestionada y almacenada por dtpf.es, sólo como se
      ...
      <ul>
        <li>
          ...
          electrónico, número de teléfono con la finalidad de responder a tus
          consultas. Por ejemplo, el Titular utiliza esos datos para dar
          respuesta a tus mensajes, dudas, quejas, comentarios o inquietudes que
          puedas tener relativas a la información incluida en el sitio Web, los
          servicios que se prestan a través del sitio Web, el tratamiento de tus
          datos personales, cuestiones referentes a los textos legales incluidos
          en el sitio Web, así como cualquier otra consulta que puedas tener y
          que no esté sujeta a las condiciones del sitio Web o de la
          contratación.
        </li>
        <li>
      ...
      <p>
        El sitio Web está alojado en un servidor privado. La seguridad de tus
      ...
      <p>
        ...
        cookies, que es una información que se almacena en tu navegador web. Se
        recogen datos anónimos a través de terceros para generar estadísticas
        que ayuden a la mejora de la experiencia de usuario.
      </p>
      ...
      <ul>
        <li>Titular de dtpf.es</li>
      </ul>
      <p>
        También puedes ver una lista de los tipos de cookies que utiliza Google
        y sus colaboradores y toda la información relativa al uso que hacen de
        cookies publicitarias.
      </p>
      <h2>Navegación Web</h2>
      <p>
        Al navegar por www.dtpf.es se pueden recoger datos no identificativos,
        que pueden incluir, la dirección IP, geolocalización, un registro de
        cómo se utilizan los servicios y sitios, hábitos de navegación y otros
      ...
      <p>
        Para ejercitar tus derechos de acceso, rectificación, cancelación,
        portabilidad y oposición tienes que enviar un correo electrónico a
        davidpizarrofrick@gmail.com junto con la prueba válida en derecho como
