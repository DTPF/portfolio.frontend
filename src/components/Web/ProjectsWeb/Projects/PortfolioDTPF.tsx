...
export default function PortfolioDTPF(props: any) {
  ...
  return (
    <ProjectLayout
      ...
      Una aplicación web hecha a medida, que muestra mi progreso en el sector de IT,
      ...
      "
      modalText={[
        `Aplicación web SPA full JavaScript, 100% responsive y con CMS a medida.
        ...
        de imágenes.`,
        `Para el front-end SPA utilizo React con una arquitectura Flux,
        creando una aplicación SPA, utilizando el componente Suspense de React para
        ...
        contacto de la web en el panel de administrador, y también recibo el mensaje 
